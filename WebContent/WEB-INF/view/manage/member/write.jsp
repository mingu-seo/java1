							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
								...
								<tbody>
									<tr>
										...
										<td>
											<input type="text" id="mname" name="mname" value="" title="사용자 이름을 입력해주세요." />
										</td>
									</tr>
									<tr>
										<th scope="row"><label for="">*이메일</label></th>
										<td>
											<input type="text" id="email" name="email" value="" title="사용자 이메일을 입력해주세요." />
										</td>
									</tr>
									<tr>
										<th scope="row"><label for="">*비밀번호</label></th>
										<td>
											<input type="password" id="pwd" name="pwd" value="" title="사용자 비밀번호를 입력해주세요." />
										</td>
									</tr>
								</tbody>
							</table>
