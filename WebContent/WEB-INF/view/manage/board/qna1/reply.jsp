							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
								...
								<tbody>
									<tr>
										...
										<td>
											<input type="text" id="cre_date" name="cre_date" class="inputTitle" value="" title="등록일을 입력해주세요"/>&nbsp;
									...
									<tr>
										...
										<td colspan="10">
											<input type="text" id="title" name="title" class="w50" title="제목을 입력해주세요" value="" />	
										</td>
									</tr>
									<tr>
								...
								<input type="hidden" name="nested" id="nested" value="<%=data.getNested()%>"/>
