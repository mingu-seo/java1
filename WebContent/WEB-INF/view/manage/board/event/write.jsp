							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
								...
								<tbody>
									<tr>
										...
										<td>
											<input type="text" id="sta_date" name="sta_date" class="inputTitle" value="<%=DateUtil.getFullToday()%>" title="시작일을 입력해주세요" />&nbsp;
										...
										<td>
											<input type="text" id="end_date" name="end_date" class="inputTitle" value="<%=DateUtil.getFullToday()%>" title="종료일을 입력해주세요" />&nbsp;
											<span id="CalregistdateIcon">
												<img src="/manage/img/calendar_icon.png" id="CalregistdateIconImg" style="cursor:pointer;"/>
											</span>
										</td>
									...
									<tr>
										...
										<td colspan="10">
											<input type="text" id="event_name" name="event_name" class="w100" title="제목을 입력해주세요" />	
										</td>
									</tr>
									<tr>
