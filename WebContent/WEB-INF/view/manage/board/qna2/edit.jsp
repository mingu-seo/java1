							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
								...
								<tbody>
									<tr>
										...
										<td>
											<input type="text" id="email" name="email" class="w100" value="<%=data.getEmail()%>"/>
										</td>
										<th scope="row"><label for="">비밀번호</label></th>
										<td>
											<input type="password" id="password" name="password" value="<%=data.getPassword()%>" />
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan="10">
											<input type="text" id="title" name="title" class="w100" value="<%=data.getTitle()%>" />	
										</td>
									</tr>
									<tr>
										...
										<td colspan="10">
											...
											style="width:100%;" ><%=data.getContents()%></textarea>	
										</td>
									</tr>
