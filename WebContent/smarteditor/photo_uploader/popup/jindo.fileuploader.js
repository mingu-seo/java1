...
jindo.FileUploader = jindo.$Class({
    ...
    upload: function () {
        ...
        this.constructor._oCallback[sFunctionName + '_success'] = jindo.$Fn(function (oParameter) {
        		// htResult를 증가 시키거나...
        		// oParameter를 배열로.. 
        		this.fireEvent("success", oParameter);
        		
            delete this.constructor._oCallback[oParameter[0].callback_func + '_success'];
            delete this.constructor._oCallback[oParameter[0].callback_func + '_error'];
            for (var i = 0; i < this._aHiddenInput.length; i++) {
