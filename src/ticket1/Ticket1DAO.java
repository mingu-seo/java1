...
public class Ticket1DAO extends SqlMapClientDAOSupport{
	...
	public int stateChange(Ticket1VO vo) throws SQLException {
		return getSqlMapClient().update("ticket1.stateChange", vo);
	}
	...
	public int plusPoint2(PointVo pv) throws SQLException {
		return (Integer)getSqlMapClient().insert("ticket1.plusPoint2", pv);
	}
	...
	pv.setPoint_no(10);
	td.minusPoint(pv);
	td.minusMemberPoint(pv);
	td.plusMemberPoint(pv);
	td.plusPoint(pv);
